...
git add -A
git commit -m 'upadte'
git fetch http://github.com/a328096728/bcslibrary
git pull http://github.com/a328096728/bcslibrary master
git status
git push http://github.com/a328096728/bcslibrary master
